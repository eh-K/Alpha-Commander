...
//Window radius to set back to if you extend the bottom to edit the textbox 
//724,277

//uint CBuffer = 0x824015E0;
//Xbox360.CallVoid(CBuffer, 0, "noclip", "god");
...
namespace RTE_Tool
{
    public partial class Form1 : Form
    {
        ...
        private void buttonLoadMap_Click(object sender, EventArgs e)
        {
            ...
            {
                string completeMapName = ("devmap " + textBoxMapName.Text);
                string tempCBUF = textBoxCBUFEntry.Text;
        ...
        //The initial click upon opening will clear the instruction text. 'Enter CBUF'
        ...
        //Pressing ENTER will send the command as if you clicked Send Command Button
        ...
        //Pressing ENTER will send the command as if you clicked Load Map Button
        ...
        //Pressing ENTER will call the entered value into g_speed.
        ...
        //Pressing ENTER will call the entered value into jump_height.
        ...
        //Pressing ENTER will tell you that you dont have to press ENTER.
        ...
        //When user clicks out of the box, it will turn light yellow.
        ...
        //When user clicks into CBUF textbox, text will be selected.
        ...
        //Clicking anywhere on the application will set a flag so any subsequent box click will select-all its contents.
